...
Deno.test("isReportLevelsSafe - test case 2", () => {
  ...
  assertEquals(
    result,
    expected,
    `Expected ${expected} but got ${result} for input "1 2 7 8 9"`,
  );
});
...
Deno.test("isReportLevelsSafe - test case 3", () => {
  ...
  assertEquals(
    result,
    expected,
    `Expected ${expected} but got ${result} for input "9 7 6 2 1"`,
  );
});
...
Deno.test("isReportLevelsSafe - test case 4", () => {
  ...
  assertEquals(
    result,
    expected,
    `Expected ${expected} but got ${result} for input "8 6 4 4 1"`,
  );
});
...
Deno.test("isReportLevelsSafe - test case 5", () => {
  ...
  assertEquals(
    result,
    expected,
    `Expected ${expected} but got ${result} for input "1 3 6 7 9"`,
  );
});
